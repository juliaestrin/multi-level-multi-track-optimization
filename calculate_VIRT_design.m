...
function result = calculate_VIRT_design(Pv_max, w_height, params)
    ...
    % calculate_Pcond(I, f, Rdc_pri, Rdc_sec, t_cu_pri, t_cu_sec, rho_cu, u0, stackup)
    ...
    % calculate_Cps_3Layer(l_winding, w_winding, w_core)
    Cps = calculate_Cps_3Layer(l_winding, w_winding, w_core);
