function Lr_3DFigure(result)
  ...
  %  Ac         = result.Ac         * 1e6;
    ...
    title_str = sprintf(['                           3D EQ-Core Transformer \n' ...
 '      Footprint Area = %.1f in^2, Total Loss = %.2f W\n' ], ...
        result.A_footprint * 1e6 * 0.00155, ...
        result.P_total ...
      );
