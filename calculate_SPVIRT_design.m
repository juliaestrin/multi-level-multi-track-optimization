% Generate an E Core Design for a Split Phase VIRT
%
% Author:  Julia Estrin
% Date:    04-02-2026
%
% Description:
%   Designs an E-core planar transformer for a Split Phase VIRT topology.
...
function result = calculate_VIRT_design(Pv_max, w_height, h_core_max, T_tx_max, ...
    ...
    lg = params.u0 * params.np^2 * Ac / (8 * params.Lu);
