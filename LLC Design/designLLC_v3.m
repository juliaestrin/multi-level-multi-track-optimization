...
function result = designLLC_v3(topology, Vin_nom, Vo_nom, Mg_nom, nt, percentReg, fsw, f_per, Pmax, Pmin, Ln)
    ...
    elseif topology == "Fullbridge LLC"
        ...
        Mg_min = N * Vo_nom / (Vin_max);
        Mg_max = N * Vo_nom / (Vin_min);
